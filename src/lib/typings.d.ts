...
declare module "zetapush-js" {
  ...
  export class Authentication {
    static delegating({ token }: Handshake.TokenAuthData): Handshake.TokenHandshake;
    static simple({ login, password }: Handshake.CredentialsAuthData): Handshake.CredentialsHandshake;
    static weak({ token }: Handshake.TokenAuthData): Handshake.TokenHandshake;
  }
